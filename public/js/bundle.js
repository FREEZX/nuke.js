  ...
  view: function (ctrl) {
    return [
      ...
      {tag: "div", attrs: {class:"container"}, children: [
        {tag: "div", attrs: {class:"col-md-6 col-md-offset-3"}, children: [
          {tag: "div", attrs: {class:"panel panel-default"}, children: [
            {tag: "div", attrs: {class:"panel-heading"}, children: ["Articles"]}, 
            {tag: "table", attrs: {class:"table table-hover"}, children: [
              {tag: "thead", attrs: {}, children: [
                {tag: "tr", attrs: {}, children: [
                  {tag: "th", attrs: {}, children: ["Title"]}, 
                  {tag: "th", attrs: {}, children: ["Content"]}, 
                  {tag: "th", attrs: {}, children: ["User"]}, 
                  {tag: "th", attrs: {}, children: ["Update"]}
                ]}
              ]}, 
              {tag: "tbody", attrs: {}, children: [
                AppStore.articles.valueOf().map(function (article) {
                  return (
                    {tag: "tr", attrs: {key:article._id}, children: [
                      {tag: "td", attrs: {}, children: [article.title]}, 
                      {tag: "td", attrs: {}, children: [article.content]}, 
                      {tag: "td", attrs: {}, children: [article.user.displayName]}, 
                      {tag: "td", attrs: {}, children: [
                        {tag: "div", attrs: {class:"form-group"}, children: [
                          {tag: "button", attrs: {class:"btn-sm btn-danger",onclick:ctrl.deleteArticle.bind(article)}, children: ["DELETE"]}
                        ]}
                      ]}
                    ]}
                  );
          ...
          {tag: "div", attrs: {className:"panel panel-default"}, children: [
            {tag: "div", attrs: {className:"panel-heading"}, children: [
              {tag: "h3", attrs: {className:"panel-title"}, children: ["New article"]}
            ]}, 
            {tag: "div", attrs: {className:"panel-body"}, children: [
              {tag: "form", attrs: {role:"form",onsubmit:ctrl.newArticle.bind(ctrl)}, children: [
                {tag: "div", attrs: {className:"form-group"}, children: [
                  {tag: "div", attrs: {className:"input-group"}, children: [
                    {tag: "div", attrs: {className:"input-group-addon"}, children: [{tag: "i", attrs: {className:"fa fa-user addon-icon"}}]}, 
                    {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"title",placeholder:"Enter title",value:ctrl.vm.title(),onchange:m.withAttr("value", ctrl.vm.title)}}
                  ]}
                ]}, 
                {tag: "div", attrs: {className:"form-group"}, children: [
                  {tag: "div", attrs: {className:"input-group"}, children: [
                    {tag: "div", attrs: {className:"input-group-addon"}, children: [{tag: "i", attrs: {className:"fa fa-key addon-icon"}}]}, 
                    {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"content",placeholder:"Enter content",value:ctrl.vm.content(),onchange:m.withAttr("value", ctrl.vm.content)}}
                  ]}
                ]}, 
                {tag: "div", attrs: {className:"form-group"}, children: [
                  {tag: "input", attrs: {type:"submit",className:"btn btn-success",value:"Create article"}}
                ]}
              ]}
            ]}
          ]}
...
},{"../stores/AppStore":16,"./Header":9,"mithril.elements":5}],8:[function(require,module,exports){
'use strict';
	...
	view: function (ctrl) {
		return [
			...
			{tag: "div", attrs: {className:"container"}, children: [
				{tag: "h2", attrs: {}, children: ["Websocket technologies benchmarks"]}, 
				{tag: "p", attrs: {}, children: ["We have created a node realtime engine benchmarking tool called ",{tag: "a", attrs: {href:"https://github.com/FREEZX/SockBench"}, children: ["SockBench"]}, " which generated the following graph.",{tag: "br", attrs: {}}, 
				"A writeup about our methods and conclusions is available in this ",{tag: "a", attrs: {href:"https://www.dropbox.com/s/6dgnftmjcjf2g5o/bare_conf.pdf"}, children: ["scientific paper"]}, "."]}, 
				{tag: "div", attrs: {config:ctrl.socketConfig()}}, 
				{tag: "p", attrs: {}, children: ["The paper shows that primus is the best possible choice due to great performance, considering it offers effortless switching of realtime engines, and it implements best practices for all supported engines."]}, 
				{tag: "p", attrs: {}, children: ["Nuke.js uses the websockets transformer by default, because it is the fastest transformer available, and does not require sticky sessions support on your load balancer."]}, 

				{tag: "h2", attrs: {}, children: ["Primus vs HTTP"]}, 
				{tag: "p", attrs: {}, children: ["This benchmark measures the needed time to make HTTP requests and Primus requests. We took advantage of primus and kept the connection open for all requests. ",{tag: "br", attrs: {}}, 
				"This highlights the biggest drawback of HTTP, which is that it's not reusing existing connections, but instead makes new connections for every request. ",{tag: "br", attrs: {}}, 
				"Nuke.js enables you to do promise-based requests with primus, and this is the preferred method you should use to achieve all the high speeds. You can also do classic HTTP requests if you really need them.",{tag: "br", attrs: {}}, 
				"To perform the benchmark yourself, check out the project on ",{tag: "a", attrs: {href:"https://github.com/FREEZX/PrimusHTTPBench"}, children: ["github"]}, "."]}, 
				{tag: "div", attrs: {config:ctrl.httpVsPrimus()}}, 

				{tag: "h2", attrs: {}, children: ["Mithril vs everything else"]}, 
				{tag: "p", attrs: {}, children: ["Mithril is a very lightweight and fast frontend MVC framework that is simple and easy to use, yet it's also extremely fast. It is included in the default package,"+' '+
				"but if you feel more comfortable with something else, it is not difficult to switch."]}, 
				{tag: "div", attrs: {config:ctrl.mithrilChart()}}
			]}
		];
	}
};
...
},{"./Header":9,"mithril.elements":5}],9:[function(require,module,exports){
'use strict';
/** @jsx m */
/* global NavLink,Link */
var m = require('mithril.elements');
...
var Header = {
  view: function() {
    ...
    return (
      {tag: "nav", attrs: {className:"navbar navbar-default navbar-fixed-top",role:"banner"}, children: [
        {tag: "div", attrs: {className:"container"}, children: [
          {tag: "div", attrs: {className:"navbar-header"}, children: [
            {tag: "button", attrs: {className:"navbar-toggle collapsed",type:"button","data-toggle":"collapse","data-target":".bs-navbar-collapse"}, children: [
              {tag: "span", attrs: {className:"sr-only"}, children: ["Toggle navigation"]}, 
              {tag: "span", attrs: {className:"icon-bar"}}, 
              {tag: "span", attrs: {className:"icon-bar"}}, 
              {tag: "span", attrs: {className:"icon-bar"}}
            ]}, 
            m("Link", {state:{to: '/'},className:"navbar-brand"}, ["☢ NUKE.JS"])
          ]}, 
          {tag: "nav", attrs: {className:"collapse navbar-collapse bs-navbar-collapse"}, children: [
            {tag: "ul", attrs: {className:"nav navbar-nav"}, children: [
              m("NavLink", {state:{to: '/'}}, ["Home"]), 
              m("NavLink", {state:{to: '/benchmarks'}}, ["Benchmarks"]), 
              m("NavLink", {state:{href: 'https://github.com/FREEZX/nuke.js'}}, ["Docs"]), 
              articleLink
            ]}, 
            {tag: "ul", attrs: {className:"nav navbar-nav navbar-right"}, children: [
              loginSpot,
...
},{"../stores/AppStore":16,"mithril.elements":5}],10:[function(require,module,exports){
'use strict';
  ...
  view: function () {
    return [Header.view(), (
      {tag: "div", attrs: {}, children: [
        {tag: "div", attrs: {className:"jumbotron"}, children: [
          {tag: "div", attrs: {className:"container"}, children: [
            {tag: "div", attrs: {className:"col-md-3 nuke_symbol"}, children: ["☢"]}, 
            {tag: "div", attrs: {className:"col-md-9"}, children: [
              {tag: "h1", attrs: {}, children: ["Nuke.js"]}, 
              {tag: "p", attrs: {}, children: ["Nuke is an extremely fast and performant node.js full-stack web framework, made with realtime in mind.",{tag: "br", attrs: {}}, 
              ...
              {tag: "blockquote", attrs: {}, children: [
                {tag: "p", attrs: {}, children: ["\"Creating and using nuke.js every day is a blast!\""]}, 
                {tag: "footer", attrs: {}, children: ["Kristijan Trajkovski, creator of nuke.js"]}
              ]}, 
              {tag: "div", attrs: {class:"row"}, children: [
                {tag: "iframe", attrs: {src:"https://ghbtns.com/github-btn.html?user=FREEZX&repo=nuke.js&type=star&count=true&size=large",frameborder:"0",scrolling:"0",width:"160px",height:"30px"}}, 
                {tag: "iframe", attrs: {src:"https://ghbtns.com/github-btn.html?user=FREEZX&repo=nuke.js&type=fork&count=true&size=large",frameborder:"0",scrolling:"0",width:"158px",height:"30px"}}, 
                {tag: "a", attrs: {href:"https://twitter.com/share",class:"twitter-share-button","data-url":"http://nukejs.com","data-text":"The superfast full-stack framework","data-via":"KTrajkovski","data-size":"large"}, children: ["Tweet"]}, 
                {tag: "script", attrs: {}, children: ["!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');"]}
              ]}, 
        ...
        {tag: "div", attrs: {className:"container"}, children: [
          {tag: "h1", attrs: {}, children: ["What?"]}, 
          {tag: "p", attrs: {}, children: ["Traditional HTTP is not a very fast way to do things. Each time you make a request, a connection is opened, headers are sent,"+' '+
          "session data is retrieved, a response is sent back and the connection is closed. "]}, 
          {tag: "p", attrs: {}, children: ["What if you need to do this many times? Precious bandwidth and time is lost to do all of these steps again and again and again."]}, 
          {tag: "p", attrs: {}, children: ["Our framework aims to reduce this by using socket technologies, which keep the connection open. This removes the overhead for opening and closing of the connection,"+' '+
          "and removes the need to retrieve session data for subsequent requests, as they all operate on the same connection. "]}, 
          ...
          {tag: "p", attrs: {}, children: [
            "Put this logo up on your site to show your support for the project.",{tag: "br", attrs: {}}, 
  ...
  view: function (ctrl) {
    ...
    return [
      ...
      {tag: "div", attrs: {}, children: [
        {tag: "div", attrs: {className:"jumbotron"}, children: [
          {tag: "div", attrs: {className:"container"}, children: [
            {tag: "div", attrs: {className:"col-md-offset-4 col-md-4"}, children: [
              {tag: "div", attrs: {className:"panel panel-default"}, children: [
                {tag: "div", attrs: {className:"panel-heading"}, children: [
                  {tag: "h3", attrs: {className:"panel-title"}, children: ["Sign in"]}
                ]}, 
                {tag: "div", attrs: {className:"panel-body"}, children: [
                  {tag: "form", attrs: {role:"form",onsubmit:ctrl.signin.bind(ctrl)}, children: [
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "div", attrs: {className:"input-group"}, children: [
                        {tag: "div", attrs: {className:"input-group-addon"}, children: [{tag: "i", attrs: {className:"fa fa-user addon-icon"}}]}, 
                        {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"username",placeholder:"Enter username",value:ctrl.vm.username(),onchange:m.withAttr("value", ctrl.vm.username)}}
                      ]}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "div", attrs: {className:"input-group"}, children: [
                        {tag: "div", attrs: {className:"input-group-addon"}, children: [{tag: "i", attrs: {className:"fa fa-key addon-icon"}}]}, 
                        {tag: "input", attrs: {type:"password",className:"form-control input-lg",name:"password",placeholder:"Enter password",value:ctrl.vm.password(),onchange:m.withAttr("value", ctrl.vm.password)}}
                      ]}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"submit",className:"btn btn-success",value:"Sign in"}}
                    ]}, 
                    {tag: "div", attrs: {className:ctrl.vm.success() ? 'alert alert-success' : '',role:"alert"}, children: [ctrl.vm.success()]}, 
                    {tag: "div", attrs: {className:ctrl.vm.error() ? 'alert alert-danger' : '',role:"alert"}, children: [ctrl.vm.error()]}
                  ]}
                ]}
              ]}
            ]}, 
            {tag: "div", attrs: {className:"col-md-offset-4 col-md-4 well"}, children: [
...
},{"../stores/AppStore":16,"./Header":9,"mithril.elements":5}],12:[function(require,module,exports){
'use strict';
var m = require('mithril.elements');
var AppStore = require('../stores/AppStore');
...
},{"../stores/AppStore":16,"mithril.elements":5}],13:[function(require,module,exports){
'use strict';
        ...
        {tag: "div", attrs: {className:"jumbotron"}, children: [
          {tag: "div", attrs: {className:"container"}, children: [
            {tag: "div", attrs: {className:"col-md-offset-4 col-md-4"}, children: [
              {tag: "div", attrs: {className:"panel panel-default"}, children: [
                {tag: "div", attrs: {className:"panel-heading"}, children: [
                  {tag: "h3", attrs: {className:"panel-title"}, children: ["Sign up"]}
                ]}, 
                {tag: "div", attrs: {className:"panel-body"}, children: [
                  {tag: "form", attrs: {onsubmit:ctrl.signup.bind(ctrl)}, children: [
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"firstName",placeholder:"Enter first name",value:ctrl.vm.firstName(),onchange:m.withAttr("value", ctrl.vm.firstName)}}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"lastName",placeholder:"Enter last name",value:ctrl.vm.lastName(),onchange:m.withAttr("value", ctrl.vm.lastName)}}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"username",placeholder:"Enter username",value:ctrl.vm.username(),onchange:m.withAttr("value", ctrl.vm.username)}}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"text",className:"form-control input-lg",name:"email",placeholder:"Enter email",value:ctrl.vm.email(),onchange:m.withAttr("value", ctrl.vm.email)}}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"password",className:"form-control input-lg",name:"password",placeholder:"Enter password",value:ctrl.vm.password(),onchange:m.withAttr("value", ctrl.vm.password)}}
                    ]}, 
                    {tag: "div", attrs: {className:"form-group"}, children: [
                      {tag: "input", attrs: {type:"submit",className:"btn btn-success",value:"Sign up"}}
                    ]}, 
                    {tag: "div", attrs: {className:ctrl.vm.success() ? 'alert alert-success' : '',role:"alert"}, children: [ctrl.vm.success()]}, 
                    {tag: "div", attrs: {className:ctrl.vm.error() ? 'alert alert-danger' : '',role:"alert"}, children: [ctrl.vm.error()]}
                  ]}
...
},{"./Header":9,"mithril.elements":5}],14:[function(require,module,exports){
'use strict';
...
var Link = m.element('Link', {
  ...
  view: function(ctrl, content) {
    ...
    return {tag: "a", attrs: {href:ctrl.state.to || ctrl.state.href,config:config}, children: [content]};
  }
});
},{"mithril.elements":5}],15:[function(require,module,exports){
'use strict';
...
},{"mithril.elements":5}],16:[function(require,module,exports){
'use strict';
var m = require('mithril.elements');
...
},{"lodash":4,"mithril.elements":5}],17:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./components/Articles":7,"./components/Benchmarks":8,"./components/Header":9,"./components/Home":10,"./components/Login":11,"./components/Logout":12,"./components/Signup":13,"./elements/Link":14,"./elements/NavLink":15,"domready":2,"es6-promise":3,"mithril.elements":5}]},{},[17]);
