	...
	view: function (ctrl) {
		return [
			...
			{tag: "div", attrs: {className:"container"}, children: [
				...
				{tag: "p", attrs: {}, children: ["The paper shows that primus is the best choice due to great performance, considering it offers effortless switching of realtime engines and it implements best practices for all supported engines."]}, 
				{tag: "p", attrs: {}, children: ["Nuke.js uses the websockets transformer by default, because it is the fastest transformer available, and does not require sticky sessions support on the load balancer."]}, 
      ...
      {tag: "div", attrs: {}, children: [
        ...
        {tag: "div", attrs: {className:"container"}, children: [
          ...
          {tag: "p", attrs: {}, children: [
            ...
            {tag: "a", attrs: {href:"benchmarks"}, children: ["Benchmarks"]}, " have proven these technologies provide the best balance between flexibility and performance, and provide a great feature set."
          ]}, 
          {tag: "h1", attrs: {}, children: ["Swag"]}, 
          {tag: "p", attrs: {}, children: [
            "Keep this logo on your site to prove you're awesome. ",{tag: "br", attrs: {}}, 
...
var Link = m.element('Link', {
  ...
  view: function(ctrl, content) {
    return {tag: "a", attrs: {href:ctrl.to,config:m.route}, children: [content]};
  }
});
